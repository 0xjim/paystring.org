...
export default [
  {
    logo: PaymentSource,
    description: `PayString, a free and open standard designed to replace account numbers that are designed to be interoperable and easier to understand — easy enough that Ripple envisions people typing the account name by memory, something that people rarely do for driver's license numbers and other common identifiers. Ripple's standard could remove the need for two people to use the same payment app for P2P transfers... The PayString standard allows people on different transfer apps to connect with
        each other.`,
  ...
  },
  {
    ...
    bottomText: 'PYMNTS',
    bottomDescription:
      'PayString Attempts To Legitimize Crypto Payments At Scale',
    link:
